...
export interface PerformanceMetrics {
    ...
    serverStartTimes: Map<string, number>;
...
export class PerformanceMonitor {
     ...
     */
    recordServerStart(serverId: string): void {
     ...
     */
    recordCommandExecution(command: string, executionTime: number): void {
     ...
     */
    createCommandTimer(command: string): () => void {
