...
exports.ServerConfigPanel = void 0;
...
class ServerConfigPanel {
     ...
     */
    async showConfigPanel(config) {
        const isEdit = !!config;
        const title = isEdit ? `Edit Server: ${config.name}` : 'Add New MCP Server';
        this.panel = vscode.window.createWebviewPanel('mcpServerConfig', title, vscode.ViewColumn.One, {
            enableScripts: true,
...
<body>
     ...
     */
    async saveServerConfig(configData, isEdit) {
        try {
     ...
     */
    async testServerConfig(configData) {
        try {
            // Basic validation
...
exports.ServerConfigPanel = ServerConfigPanel;
//# sourceMappingURL=serverConfigPanel.js.map