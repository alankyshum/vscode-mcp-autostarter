...
exports.MCPConfigurationManager = void 0;
...
class MCPConfigurationManager {
    ...
    getMCPConfiguration() {
        try {
            ...
            const userServers = Object.fromEntries(Object.entries(servers).filter(([key]) => !key.includes('-internal')));
     ...
     */
    setupConfigurationWatcher(onConfigChanged) {
...
exports.MCPConfigurationManager = MCPConfigurationManager;
